...
<%@ taglib prefix="multi-checkout-paypal" tagdir="/WEB-INF/tags/addons/paypaladdon/desktop/checkout/multi" %>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="span-14 append-1">
		<multi-checkout-paypal:summaryFlow deliveryAddress="${cartData.deliveryAddress}" deliveryMode="${deliveryMode}" paymentInfo="${paymentInfo}" requestSecurityCode="${requestSecurityCode}" cartData="${cartData}"/>
