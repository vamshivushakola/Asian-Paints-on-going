...
/**
 * This is the extension manager of the Asmtrail extension.
 */
public class AsmtrailManager extends GeneratedAsmtrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AsmtrailManager.class.getName());
	 ...
	 */
	public static AsmtrailManager getInstance()
	{
		return (AsmtrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AsmtrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AsmtrailManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AsmtrailManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AsmtrailManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AsmtrailManager called, current tenant: " + getTenant().getTenantID());
		}
	}
