 ...
 *
 */
package de.hybris.platform.addons.asianpaintscheckoutaddon.jalo;
...
import de.hybris.platform.addons.asianpaintscheckoutaddon.constants.AsianpaintscheckoutaddonConstants;



/**
 * This is the extension manager of the Asianpaintscheckoutaddon extension.
 */
public class AsianpaintscheckoutaddonManager extends GeneratedAsianpaintscheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AsianpaintscheckoutaddonManager.class.getName());
	 ...
	 */
	public static AsianpaintscheckoutaddonManager getInstance()
	{
		return (AsianpaintscheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AsianpaintscheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AsianpaintscheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AsianpaintscheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AsianpaintscheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AsianpaintscheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
