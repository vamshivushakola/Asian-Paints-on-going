 ...
 *
 */
package de.hybris.platform.addons.asianpaintscheckoutaddon.hmc;
...
/**
 * Provides necessary meta information about the asianpaintscheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.5
 */
public class AsianpaintscheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AsianpaintscheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.addons.asianpaintscheckoutaddon.hmc.locales";
