...
/**
 * Generated class for type <code>AsianpaintsFulfilmentProcessManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedAsianpaintsFulfilmentProcessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, AsianpaintsFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, AsianpaintsFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return AsianpaintsFulfilmentProcessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, AsianpaintsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, AsianpaintsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, AsianpaintsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, AsianpaintsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
