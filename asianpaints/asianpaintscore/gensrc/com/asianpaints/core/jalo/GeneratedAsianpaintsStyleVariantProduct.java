 ...
 * --- Generated at Jun 18, 2016 6:07:30 PM                     ---
 * ----------------------------------------------------------------
 */
...
/**
 * Generated class for type {@link com.asianpaints.core.jalo.AsianpaintsStyleVariantProduct AsianpaintsStyleVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedAsianpaintsStyleVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>AsianpaintsStyleVariantProduct.style</code> attribute **/
	public static final String STYLE = "style";
	/** Qualifier of the <code>AsianpaintsStyleVariantProduct.swatchColors</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AsianpaintsStyleVariantProduct.style</code> attribute.
	...
	public String getStyle(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedAsianpaintsStyleVariantProduct.getStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AsianpaintsStyleVariantProduct.style</code> attribute. 
	...
	public void setStyle(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedAsianpaintsStyleVariantProduct.setStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AsianpaintsStyleVariantProduct.swatchColors</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AsianpaintsStyleVariantProduct.swatchColors</code> attribute. 
