...
public class GeneratedAsianpaintsCoreConstants
{
	public static final String EXTENSIONNAME = "asianpaintscore";
	public static class TC
	{
		public static final String APPARELPRODUCT = "ApparelProduct".intern();
		public static final String APPARELSIZEVARIANTPRODUCT = "ApparelSizeVariantProduct".intern();
		public static final String APPARELSTYLEVARIANTPRODUCT = "ApparelStyleVariantProduct".intern();
		public static final String ASIANPAINTSPRODUCT = "AsianpaintsProduct".intern();
		public static final String ASIANPAINTSSIZEVARIANTPRODUCT = "AsianpaintsSizeVariantProduct".intern();
	...
	protected GeneratedAsianpaintsCoreConstants()
	{
		// private constructor
	}
