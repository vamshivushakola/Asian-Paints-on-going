...
public class DefaultVoucherController extends AbstractPageController
{
			...
			final HttpServletRequest request)
	{
		try
		{
			...
			if (null == voucherCode || voucherCode.isEmpty())
			{
				...
				//return REDIRECT_URL_CART + "?Message=Voucher Code can not be empty";
				LOG.warn("Voucher Code can not be empty");
			}
			System.out.println("Called in Voucher");
		...
		catch (final VoucherOperationException e)
		{
			...
			return REDIRECT_URL_CART + "?Message=" + e.getMessage();
		...
		return REDIRECT_URL_CART + "?Message=Voucher Applied Successfully";
	...
	public String releaseVoucher()
	{
		...
		return REDIRECT_URL_CART + "?Message=Voucher Released Successfully";
	}
