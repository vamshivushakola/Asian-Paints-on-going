...
public class LoginPageController extends AbstractLoginPageController
{
	...
	@Resource(name = "defaultAsianpaintsCustomerFacade")
	private CustomerFacade defaultAsianpaintsCustomerFacade;

	@Resource(name = "asianpaintsRegistrationFormValidator")
	private Validator asianpaintsRegistrationFormValidator;
	...
	//Added To get Form on front end to display contact number
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(new AsianpaintsRegisterForm());
	...
	{
		System.out.println("=======================Inside processRegisterUserRequest=============================");
		...
		data.setContactNumber(form.getContactNumber());
		data.setDateOfBirth(form.getDateOfBirth());
		try
		{
			//getCustomerFacade().register(data);
			defaultAsianpaintsCustomerFacade.register(data);
