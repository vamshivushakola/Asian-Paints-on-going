...
<div class="userRegister">
	...
	<form:form method="post" commandName="asianpaintsRegisterForm" action="${action}">
		<div class="form_field-elements js-recaptcha-captchaaddon">
			...
			<formElement:formInputBox idKey="register.contactNumber" labelKey="register.contactNumber" path="contactNumber" inputCSS="text" mandatory="true"/>
			
			<!-- <p>Date Of Birth: <input type="date" name="dateOfBirth"></p> -->
			<formElement:formInputBox idKey="datepicker" labelKey="register.dateOfBirth" path="dateOfBirth" inputCSS="text" mandatory="true"/>
