	...
	<c:forEach items="${entries}" var="entry" end="${numberShowing - 1}">
		...
		<li class="popupCartItem">
			...
			<div class="itemDesc">
				...
				<%-- <a class="itemAddonsOrderEntry" >${entry.addonsOrderEntry}</a> --%>
				<%-- <div class="itemAddonsOrderEntry"><span class="label"><spring:theme code="popup.cart.addonsOrderEntry"/></span>${entry.addonsOrderEntry}</div> --%>
