 ...
 *  
 */
package de.hybris.platform.asmtrailstorefront.jalo;
...
import de.hybris.platform.asmtrailstorefront.constants.AsmtrailstorefrontConstants;



/**
 * This is the extension manager of the Asmtrailstorefront extension.
 */
public class AsmtrailstorefrontManager extends GeneratedAsmtrailstorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AsmtrailstorefrontManager.class.getName());
	 ...
	 */
	public static AsmtrailstorefrontManager getInstance()
	{
		return (AsmtrailstorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AsmtrailstorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AsmtrailstorefrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AsmtrailstorefrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AsmtrailstorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AsmtrailstorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
